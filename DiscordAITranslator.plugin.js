...
Please click <a style="font-weight: 500;">Download Now</a> to install it.</div>`, template.content.firstElementChild.querySelector("a").addEventListener("click", this.downloadLibrary), template.content.firstElementChild;
        ...
        let translationProtectionSignatureVersion = "2026-06-16-auto-protect-v11", translateIconGeneral = '<svg name="Translate" width="24" height="24" viewBox="0 0 24 24"><mask/><path fill="currentColor" mask="url(#translateIconMask)" d="m 9.6568988,1.9999999 c -1.141416,0 -0.951614,1.2688185 -0.951614,1.2688185 v 0.6505173 h -5.392479 c 0,0 -1.2688185,-0.1898024 -1.2688185,0.9516139 0,1.1414159 1.2688185,0.9516139 1.2688185,0.9516139 H 12.426863 C 12.695162,7.2780713 11.349082,9.1398691 9.7646988,10.765256 8.6555628,9.6878231 7.4332858,8.3134878 6.8664892,7.065981 6.6161862,6.515072 5.9881318,6.6956414 5.7283935,6.9736693 5.1836529,7.5567679 5.5785907,8.592173 6.0833902,9.3409331 c 0.246901,0.366224 1.3724726,1.5182279 2.4570966,2.5995909 -1.6322361,1.477469 -3.154699,2.550028 -3.154699,2.550028 0,0 -1.0769951,0.696378 -0.322161,1.552568 0.7548319,0.856187 1.5810669,-0.125147 1.5810669,-0.125147 0,0 1.5136611,-1.082765 3.2203701,-2.6696 0.5195872,0.508635 0.8970952,0.874172 0.8970952,0.874172 0,0 0.82821,0.985394 1.582925,0.09231 0.754714,-0.893081 -0.354377,-1.545753 -0.354377,-1.545753 0.0097,0.03486 -0.34186,-0.224086 -0.864878,-0.666625 1.804964,-1.884163 3.470802,-4.1622897 3.47686,-6.1799145 h 1.398302 c 0,0 1.268819,0.2176541 1.268819,-0.9516139 0,-1.1692683 -1.268819,-0.9516139 -1.268819,-0.9516139 H 10.608512 V 3.2688184 c 0,0 0.189804,-1.2688185 -0.9516132,-1.2688185 z M 15.056812,10.104826 10.536646,22 h 2.379035 l 0.964624,-2.537637 h 4.732049 L 19.576978,22 h 2.379035 L 17.435847,10.104826 Z m 1.189517,3.130537 1.643021,4.323772 h -3.286042 z"/><extra/></svg>', translateIconMask = '<mask id="translateIconMask" fill="black"><path fill="white" d="M 0 0 H 24 V 24 H 0 Z"/><path fill="black" d="M24 12 H 12 V 24 H 24 Z"/></mask>', translateIcon = translateIconGeneral.replace("<extra/>", "").replace("<mask/>", "").replace(' mask="url(#translateIconMask)"', ""), translateIconUntranslate = translateIconGeneral.replace("<extra/>", '<path fill="none" stroke="#f04747" stroke-width="2" d="m 14.702359,14.702442 8.596228,8.596148 m 0,-8.597139 -8.59722,8.596147 z"/>').replace("<mask/>", translateIconMask), TranslateButtonComponent = (_a = class extends BdApi.React.Component {
          ...
          async detectLanguageFromInput() {
            let text = (this.state.detectorText || "").trim();
          ...
          applyDetectedLanguage(place, direction) {
            let detectedLanguageId = this.state.detectedLanguageId;
          ...
          renderLanguageDetector() {
            let detectedLanguageId = this.state.detectedLanguageId, detectedLanguage = detectedLanguageId && _this.getLanguageData(detectedLanguageId);
          ...
          "−−−−−": "0",
          _: "··−−·−"
        }, googleLanguages = ["af", "am", "ar", "az", "be", "bg", "bn", "bs", "ca", "ceb", "co", "cs", "cy", "da", "de", "el", "en", "eo", "es", "et", "eu", "fa", "fi", "fr", "fy", "ga", "gd", "gl", "gu", "ha", "haw", "hi", "hmn", "hr", "ht", "hu", "hy", "id", "ig", "is", "it", "iw", "ja", "jw", "ka", "kk", "km", "kn", "ko", "ku", "ky", "la", "lb", "lo", "lt", "lv", "mg", "mi", "mk", "ml", "mn", "mr", "ms", "mt", "my", "ne", "nl", "no", "ny", "or", "pa", "pl", "ps", "pt", "ro", "ru", "rw", "sd", "si", "sk", "sl", "sm", "sn", "so", "sq", "sr", "st", "su", "sv", "sw", "ta", "te", "tg", "th", "tk", "tl", "tr", "tt", "ug", "uk", "ur", "uz", "vi", "xh", "yi", "yo", "zh-CN", "zh-TW", "zu"], translationEngines = {
          googleapi: {
            name: "Google",
            auto: !0,
        ...
        let HistoricalTranslationJob = _HistoricalTranslationJob, protectionLogic = {
          ...
          resetQueueTimer() {
            autoTranslationQueueRetryTimer && clearTimeout(autoTranslationQueueRetryTimer), autoTranslationQueueRetryTimer = null;
          },
          resetAutoTranslationTracking(plugin, channelId = null) {
            channelId ? (delete autoTranslationChannelStates[channelId], receivedTranslationRuntime.resetLoadedMessageTracking(channelId)) : (autoTranslationChannelStates = {}, receivedTranslationRuntime.resetLoadedMessageTracking()), plugin.clearAutoTranslationEligibleReplyPreviewMessages(channelId), (!channelId || lastAutoTranslationChannelId == channelId) && (lastAutoTranslationChannelId = null);
          },
          getAutoTranslationChannelState(_plugin, channelId) {
            return channelId ? (autoTranslationChannelStates[channelId] || (autoTranslationChannelStates[channelId] = {
              initialized: !1,
              boundaryMessageId: null
            }), autoTranslationChannelStates[channelId]) : null;
          },
          prepareAutoTranslationChannelSession(plugin, channelId) {
            if (!channelId || lastAutoTranslationChannelId == channelId) return;
            let previousChannelId = lastAutoTranslationChannelId;
            previousChannelId && plugin.clearAutoTranslationQueue(previousChannelId), lastAutoTranslationChannelId = channelId;
            let channelState = receivedTranslationRuntime.getAutoTranslationChannelState(plugin, channelId);
            channelState.initialized = !1, channelState.boundaryMessageId = null, receivedTranslationRuntime.resetLoadedMessageTracking(channelId), plugin.clearAutoTranslationEligibleReplyPreviewMessages(channelId), plugin.getReceivedAutoTranslateScope() == "new_only" && plugin.clearDisplayedAutoTranslations(channelId);
          },
          ...
          createLiveTranslationRequest(plugin, message, channelId, originalContentData = null, signature = null) {
            ...
            return liveTranslationRequests[receivedTranslationRuntime.getLiveTranslationRequestKey(plugin, request.messageId, channelId)] = request, request;
          },
          isLiveTranslationRequestCurrent(plugin, request, message = null) {
            if (!request || !pluginRuntimeActive || request.generation != liveTranslationRuntimeGeneration || !plugin.isTranslationEnabled(request.channelId)) return !1;
            let key = receivedTranslationRuntime.getLiveTranslationRequestKey(plugin, request.messageId, request.channelId);
            if (liveTranslationRequests[key] !== request) return !1;
            if (!message) return !0;
            let currentContentData = plugin.extractOriginalContentData(message);
          ...
          finishLiveTranslationRequest(plugin, request) {
            if (!request) return !1;
            let key = receivedTranslationRuntime.getLiveTranslationRequestKey(plugin, request.messageId, request.channelId);
            return liveTranslationRequests[key] === request && delete liveTranslationRequests[key], queuedAutoTranslations[request.messageId] === request && delete queuedAutoTranslations[request.messageId], !0;
          },
          invalidateLiveTranslationRequests(plugin, channelId = null) {
            channelId || liveTranslationRuntimeGeneration++;
            for (let key of Object.keys(liveTranslationRequests)) {
              let request = liveTranslationRequests[key];
              channelId && request.channelId != channelId || (delete liveTranslationRequests[key], queuedAutoTranslations[request.messageId] === request && delete queuedAutoTranslations[request.messageId]);
            }
          },
          invalidateLiveTranslationMessage(plugin, messageId, channelId, currentSignature) {
            ...
            let key = receivedTranslationRuntime.getLiveTranslationRequestKey(plugin, messageId, channelId), request = liveTranslationRequests[key];
            return !request || request.signature == currentSignature ? !1 : (delete liveTranslationRequests[key], queuedAutoTranslations[request.messageId] === request && delete queuedAutoTranslations[request.messageId], !0);
          },
          clearAutoTranslationQueue(plugin, channelId = null) {
            if (plugin.cancelHistoricalTranslationJobs(channelId, channelId ? "channel-queue-cleared" : "all-queues-cleared"), plugin.cancelPendingChannelTitleTranslation(channelId), receivedTranslationRuntime.invalidateLiveTranslationRequests(plugin, channelId), plugin.invalidateSentAutomaticTranslationRequests(channelId), !channelId) {
              autoTranslationQueue = [], queuedAutoTranslations = {}, queuedReplyPreviewTranslations = {}, autoTranslationEligibleReplyPreviewMessages = {}, replyPreviewRenderMessageIds = {}, deferredTranslationRerenderPending = !1, receivedTranslationRuntime.resetLoadedMessageTracking(), receivedTranslationRuntime.resetQueueTimer(), plugin.clearLoadedAutoTranslationStatus();
              return;
            }
            autoTranslationQueue = autoTranslationQueue.filter((queueItem) => {
              let shouldRemove = queueItem && queueItem.channel && queueItem.channel.id == channelId;
              return shouldRemove && queueItem.message && queueItem.message.id && (!queueItem.liveRequest || queuedAutoTranslations[queueItem.message.id] === queueItem.liveRequest) && delete queuedAutoTranslations[queueItem.message.id], !shouldRemove;
            });
            for (let messageId of Object.keys(queuedReplyPreviewTranslations)) {
              let request = queuedReplyPreviewTranslations[messageId];
              (request == channelId || request && request.channelId == channelId) && delete queuedReplyPreviewTranslations[messageId];
            }
            delete autoTranslationEligibleReplyPreviewMessages[channelId], receivedTranslationRuntime.resetLoadedMessageTracking(channelId), !autoTranslationQueue.length && autoTranslationQueueRetryTimer && (clearTimeout(autoTranslationQueueRetryTimer), autoTranslationQueueRetryTimer = null), loadedAutoTranslationStatus.channelId == channelId && plugin.clearLoadedAutoTranslationStatus();
          },
          scheduleAutoTranslationQueueRetry(plugin) {
            autoTranslationQueueRetryTimer || (autoTranslationQueueRetryTimer = setTimeout((_2) => {
              autoTranslationQueueRetryTimer = null, plugin.processAutoTranslationQueue();
            }, AUTO_TRANSLATION_QUEUE_RETRY_DELAY));
          },
          scheduleAutoTranslationBackoff(plugin, ms) {
            ms && (autoTranslationBackoffUntil = Math.max(autoTranslationBackoffUntil || 0, Date.now() + ms), receivedTranslationRuntime.scheduleAutoTranslationQueueRetry(plugin));
          },
          createQueueItem(plugin, message, channel, originalContentData = null, queueOptions = {}) {
            let normalizedOriginalContentData = originalContentData || plugin.extractOriginalContentData(message);
            return {
              message,
              channel,
          ...
          enqueueLiveItem(plugin, queueItem) {
            return autoTranslationQueue.unshift(queueItem), plugin.processAutoTranslationQueue(), !0;
          },
          queueAutoTranslateMessage(plugin, message, channel, originalContentData = null, queueOptions = {}) {
            if (!(queueOptions.cachedTranslation || null) && !plugin.shouldAutoTranslateReceivedMessage(message, channel, originalContentData) || queueOptions.historicalLoad && !plugin.isMessageWithinLoadedRange(message)) return !1;
            let queueItem = receivedTranslationRuntime.createQueueItem(plugin, message, channel, originalContentData, queueOptions);
            if (queueItem.historicalLoad) return plugin.collectHistoricalTranslationMessage(queueItem);
            let channelId = channel && channel.id || plugin.getMessageChannelId(message);
            return queueItem.liveRequest = receivedTranslationRuntime.createLiveTranslationRequest(plugin, message, channelId, queueItem.originalContentData), queueItem.liveRequest ? (queuedAutoTranslations[message.id] = queueItem.liveRequest, receivedTranslationRuntime.enqueueLiveItem(plugin, queueItem)) : !1;
          },
          beginQueueProcessing(plugin) {
            return isTranslating || isLiveAutoTranslating ? !1 : Date.now() < (autoTranslationBackoffUntil || 0) ? (receivedTranslationRuntime.scheduleAutoTranslationQueueRetry(plugin), !1) : !0;
          },
          finishQueueIfEmpty() {
          ...
          handleCachedQueueItem(plugin, queueItem) {
            ...
            let channelId = queueItem.channel && queueItem.channel.id || "__global";
            return plugin.applyStoredTranslationToMessage(queueItem.message, Object.assign({ channelId, auto: !0 }, queueItem.cachedTranslation), queueItem.originalContentData), receivedTranslationRuntime.finishLiveTranslationRequest(plugin, queueItem.liveRequest), plugin.scheduleTranslationRerender({ batched: !0, allowWhileTyping: !0 }), !0;
          },
          ...
          translateQueuedItem(plugin, queueItem) {
            isLiveAutoTranslating = !0, plugin.translateMessage(queueItem.message, queueItem.channel, {
              ...
              receivedTranslationRuntime.finishLiveTranslationRequest(plugin, queueItem.liveRequest), isLiveAutoTranslating = !1, plugin.processAutoTranslationQueue();
            }).catch((_2) => {
              receivedTranslationRuntime.finishLiveTranslationRequest(plugin, queueItem.liveRequest), isLiveAutoTranslating = !1, plugin.processAutoTranslationQueue();
            });
          },
          createProcessMessagesContext(plugin, e) {
            ...
            if (historicalLoadedPass) {
              ...
              plugin.attachAutoTranslationScrollWatcher(), plugin.updateLoadedAutoTranslationStatus({ active: !0, collecting: !0, done: !1, channelId, batch: (loadedAutoTranslationStatus.batch || 0) + 1, total: 0, processed: 0, displayed: 0, skipped: 0, failed: 0, retryable: retainedFailedCount, aiDropped: 0, lastSkipReason: "", lastSkipPreview: "" });
            }
            return {
              channel,
              channelId,
          ...
          shouldCollectHistoricalStreamMessage(plugin, message, context) {
            ...
            loadedAutoTranslationSeenMessages[context.channelId] || (loadedAutoTranslationSeenMessages[context.channelId] = {});
            let seenMessages = loadedAutoTranslationSeenMessages[context.channelId], wasSeen = !!seenMessages[message.id];
            return seenMessages[message.id] = !0, plugin.getReceivedAutoTranslateScope() != "loaded_messages" ? !1 : context.historicalLoadedPass ? !0 : !wasSeen && !plugin.isMessageIdNewer(message.id, context.autoTranslateBoundaryId);
          },
          ...
          finishProcessMessages(plugin, context) {
            if (context.channelState && (context.channelState.boundaryMessageId = plugin.getNewestMessageId(context.channelState.boundaryMessageId, context.highestMessageId), context.shouldInitializeAutoTranslation && (context.channelState.initialized = !0)), context.historicalLoadedPass || context.collectedHistoricalMessages) {
              ...
              historicalEntry && (historicalEntry.runningPromise || historicalEntry.jobs.length) || plugin.updateLoadedAutoTranslationStatus({ active: !1, collecting: !1, done: !0, channelId: context.channelId, batch: loadedAutoTranslationStatus.batch || 1, total: 0, processed: 0 });
            }
          },
...
`).trim() : content;
          ...
          getStableReplyPreviewOriginalContent(plugin, message) {
            if (!message) return "";
            let currentContent = (message.content || "").trim(), storedTranslations = [replyPreviewTranslations[message.id], translatedMessages[message.id]].filter(Boolean);
          ...
          getReplyPreviewDisplayContentForMessage(plugin, message, channelId = null) {
            if (!message) return "";
            let originalContent = translationDisplayLogic.getStableReplyPreviewOriginalContent(plugin, message) || (message.content || "").trim(), storedTranslation = translatedMessages[message.id] || replyPreviewTranslations[message.id];
          ...
          applyStoredTranslationToMessage(plugin, message, translation, originalContentData = null) {
            ...
            return delete suppressedAutoTranslations[message.id], oldMessages[message.id] = new BDFDB.DiscordObjects.Message(message), oldMessages[message.id].originalContentData = originalContentData || plugin.extractOriginalContentData(message), translatedMessages[message.id] = storedTranslation, storedTranslation;
          },
          clearDisplayedTranslationState(_plugin, messageId, options = {}) {
            ...
            delete translatedMessages[messageId], config.preserveSuppressed || delete suppressedAutoTranslations[messageId], config.clearReplyPreview && (delete replyPreviewTranslations[messageId], delete queuedReplyPreviewTranslations[messageId]);
          },
          getStoredTranslationChannelId(_plugin, messageId, fallbackChannelId = null, translation = null) {
            ...
            let displayedTranslation = translatedMessages[messageId];
            if (displayedTranslation && displayedTranslation.channelId) return displayedTranslation.channelId;
            let replyPreviewTranslation = replyPreviewTranslations[messageId];
            return replyPreviewTranslation && replyPreviewTranslation.channelId ? replyPreviewTranslation.channelId : oldMessages[messageId] && oldMessages[messageId].channel_id || null;
          },
          ...
          getActiveReplyPreviewTranslation(plugin, message, channelId) {
            ...
            return translation ? translationDisplayLogic.shouldDisplayStoredTranslation(plugin, translation, channelId) ? translation : (delete replyPreviewTranslations[message.id], delete queuedReplyPreviewTranslations[message.id], null) : null;
          },
          processMessageReply(plugin, e) {
            if (!e.instance.props.referencedMessage || !e.instance.props.referencedMessage.message) return;
            let referencedMessage = e.instance.props.referencedMessage.message, stableReferencedMessage = translationDisplayLogic.getStableReplyPreviewMessage(plugin, referencedMessage), baseMessage = e.instance.props.baseMessage || null, channelId = plugin.getMessageChannelId(baseMessage || stableReferencedMessage), storedMessageTranslation = translatedMessages[stableReferencedMessage.id];
          ...
          resolveLoadedMessageContentTranslation(plugin, message, channelId) {
            ...
            return cachedTranslation && liveMessage ? translation = translationDisplayLogic.applyStoredTranslationToMessage(plugin, message, Object.assign({ channelId, auto: !0 }, cachedTranslation), originalContentData) : (cachedTranslation || plugin.shouldAutoTranslateReceivedMessage(message, { id: channelId }, originalContentData)) && plugin.queueAutoTranslateMessage(message, { id: channelId }, originalContentData, {
              historicalLoad: !liveMessage,
              deferWhileReading: !1,
              cachedTranslation: liveMessage ? null : cachedTranslation
            }), translation;
          },
          ...
          getAutoTranslateDecisionMode(plugin) {
            return receivedSettingsPolicy.getFilterSettings(plugin).autoTranslateDecisionMode == "ai" ? "ai" : "basic";
          },
        ...
        }, sentAutomaticTranslationRuntime = {
          create(plugin, channelId, originalText, messageId = null) {
            ...
            return sentAutomaticTranslationRequests[request.id] = request, request;
          },
          ...
          finish(_plugin, request) {
            return !request || request.completed ? !1 : (request.completed = !0, sentAutomaticTranslationRequests[request.id] === request && delete sentAutomaticTranslationRequests[request.id], !0);
          },
          complete(plugin, request, translatedText, submit) {
            ...
            let isCurrent = sentAutomaticTranslationRuntime.isCurrent(plugin, request), nextText = isCurrent ? translatedText : request.originalText;
            return sentAutomaticTranslationRuntime.finish(plugin, request), Promise.resolve(submit(nextText)).then((_2) => (isCurrent && (request.messageId ? sentAutomaticTranslationRuntime.rememberMessage(plugin, request.messageId, request.channelId, request.originalText, nextText) : sentAutomaticTranslationRuntime.trackPending(plugin, request.channelId, request.originalText, nextText)), !0));
          },
          prune(_plugin) {
            let cutoff = Date.now() - SENT_ORIGINAL_MATCH_TTL;
          ...
          trackPending(plugin, channelId, originalText, submittedText) {
            return originalText = String(originalText || ""), submittedText = String(submittedText || ""), !channelId || !originalText || !submittedText || originalText == submittedText ? !1 : (sentAutomaticTranslationRuntime.prune(plugin), pendingSentOriginalMessages.push({ channelId, originalText, submittedText, createdAt: Date.now() }), pendingSentOriginalMessages.length > MAX_SENT_ORIGINAL_ENTRIES && pendingSentOriginalMessages.splice(0, pendingSentOriginalMessages.length - MAX_SENT_ORIGINAL_ENTRIES), !0);
          },
          rememberMessage(plugin, messageId, channelId, originalText, submittedText) {
            ...
            if (originalText = String(originalText || ""), submittedText = String(submittedText || ""), !originalText || !submittedText || originalText == submittedText)
              return delete sentOriginalMessages[messageId], !1;
            sentAutomaticTranslationRuntime.prune(plugin), sentOriginalMessages[messageId] = { channelId, originalText, submittedText, capturedAt: Date.now() };
            let messageIds = Object.keys(sentOriginalMessages);
            return messageIds.length > MAX_SENT_ORIGINAL_ENTRIES && messageIds.sort((left, right) => sentOriginalMessages[left].capturedAt - sentOriginalMessages[right].capturedAt).slice(0, messageIds.length - MAX_SENT_ORIGINAL_ENTRIES).forEach((id) => delete sentOriginalMessages[id]), !0;
          },
          captureEcho(plugin, message, channelId = null) {
            if (!message || !message.id || !plugin.isOwnMessage(message)) return !1;
            ...
            let pendingIndex = pendingSentOriginalMessages.findIndex((entry) => entry.channelId == channelId && entry.submittedText == submittedText);
            if (pendingIndex < 0) return !1;
            let pending = pendingSentOriginalMessages.splice(pendingIndex, 1)[0];
          ...
          getEditableText(plugin, messageId, currentText) {
            sentAutomaticTranslationRuntime.prune(plugin);
            let stored = messageId && sentOriginalMessages[messageId];
            return stored ? String(currentText || "") != stored.submittedText ? (delete sentOriginalMessages[messageId], currentText) : stored.originalText : currentText;
          },
          invalidate(_plugin, channelId = null) {
            channelId || sentAutomaticTranslationRuntimeGeneration++;
            for (let requestId of Object.keys(sentAutomaticTranslationRequests)) {
              let request = sentAutomaticTranslationRequests[requestId];
              channelId && request.channelId != channelId || delete sentAutomaticTranslationRequests[requestId];
            }
          }
...
.translator-settings-inline-actions {
          ...
          getMessageDetectionSourceText(message) {
            ...
            let originalContentData = oldMessages[message.id] && oldMessages[message.id].originalContentData;
...
`).trim();
          ...
          refreshReceivedMessageSourceState(message, channelId = null) {
            if (!message || !message.id || !oldMessages[message.id]) return !1;
            let currentContent = this.normalizeExtractedMessageText(message.content).trim();
            if (!currentContent) return !1;
            let storedOriginal = oldMessages[message.id], storedOriginalData = storedOriginal.originalContentData || {}, translation = translatedMessages[message.id] || {};
            return [
              ...
              translation.content
            ].map((value) => this.normalizeExtractedMessageText(value).trim()).filter(Boolean).includes(currentContent) ? !1 : (delete oldMessages[message.id], this.clearDisplayedTranslationState(message.id, { clearReplyPreview: !0 }), this.clearCachedTranslation(message.id), !0);
          }
          extractOriginalContentData(message, options = {}) {
            let storedOriginalContentData = message && message.id && oldMessages[message.id] && oldMessages[message.id].originalContentData;
...
` + embed.footerText);
          ...
          scheduleTranslationCacheSave() {
            translationCacheSaveTimer && clearTimeout(translationCacheSaveTimer), translationCacheSaveTimer = setTimeout((_2) => {
              BDFDB.DataUtils.save(translationCache, this, "translationCache"), translationCacheSaveTimer = null;
            }, 300);
          }
          ...
          clearCachedTranslation(messageId) {
            !messageId || !translationCache[messageId] || (delete translationCache[messageId], this.scheduleTranslationCacheSave());
          }
          ...
          getReplyPreviewTranslation(message, channelId) {
            if (!message || !message.id) return null;
            let storedTranslation = replyPreviewTranslations[message.id];
            if (!storedTranslation) return null;
            let signature = this.createReplyPreviewSignature(message, channelId);
            return storedTranslation.signature != signature ? (delete replyPreviewTranslations[message.id], null) : storedTranslation;
          }
...
`))), extraClasses.length && (props.className = BDFDB.DOMUtils.formatClassName(className, ...extraClasses)), props.children != null && (props.children = this.tagReplyPreviewRenderNode(props.children)), BDFDB.ReactUtils.createElement(node.type, Object.assign({}, props, { key: node.key, ref: node.ref }));
          ...
          queueReplyPreviewTranslation(message, channelId, contextOptions = {}) {
            ...
            if (baseMessage && !this.shouldAutoTranslateReplyPreview(baseMessage, message, channelId) || suppressedAutoTranslations[message.id] || !this.isTranslationEnabled(channelId) || this.isOwnMessage(message)) return;
            let originalContent = (message.content || "").trim();
            if (!originalContent) return;
            let signature = this.createReplyPreviewSignature(message, channelId, originalContent), existingTranslation = replyPreviewTranslations[message.id];
            ...
            if (cachedTranslation) {
              ...
              previewTranslation && (replyPreviewTranslations[message.id] = previewTranslation);
              return;
            }
            let request = { channelId, signature };
            queuedReplyPreviewTranslations[message.id] = request, this.translateText(originalContent, messageTypes.RECEIVED, (translation, input, output) => {
              !pluginRuntimeActive || queuedReplyPreviewTranslations[message.id] !== request || (delete queuedReplyPreviewTranslations[message.id], this.createReplyPreviewSignature(message, channelId, (message.content || "").trim()) == signature && (baseMessage && !this.shouldAutoTranslateReplyPreview(baseMessage, message, channelId) || this.isTranslationEnabled(channelId) && translation && (replyPreviewTranslations[message.id] = {
                signature,
                channelId,
                auto: !0,
          ...
          clearAutoTranslationEligibleReplyPreviewMessages(channelId = null) {
            channelId ? delete autoTranslationEligibleReplyPreviewMessages[channelId] : autoTranslationEligibleReplyPreviewMessages = {};
          }
          markAutoTranslationEligibleReplyPreviewMessage(channelId, messageId) {
            !channelId || !messageId || (autoTranslationEligibleReplyPreviewMessages[channelId] || (autoTranslationEligibleReplyPreviewMessages[channelId] = {}), autoTranslationEligibleReplyPreviewMessages[channelId][messageId] = !0);
          }
          ...
          pauseHistoricalAutoTranslationForNavigation(duration = 1800) {
            ...
            autoTranslationUserScrollChannelId = channelId || null, lastAutoTranslationUserScrollTime = Date.now() + Math.max(0, duration - AUTO_TRANSLATION_SCROLL_IDLE_DELAY), channelId && this.scheduleAutoTranslationScrollIdleFinish(channelId, duration);
          }
          ...
          shouldAutoTranslateReplyPreview(baseMessage, referencedMessage, channelId) {
            return !this.settings.general.showOriginalInReplyPreview || !channelId || !baseMessage || !baseMessage.id || !referencedMessage || !referencedMessage.id || !this.isTranslationEnabled(channelId) || this.isOwnMessage(baseMessage) || this.isOwnMessage(referencedMessage) || suppressedAutoTranslations[referencedMessage.id] ? !1 : this.getReceivedAutoTranslateScope() == "loaded_messages" ? this.isMessageWithinLoadedRange(baseMessage) : this.isAutoTranslationEligibleReplyPreviewMessage(channelId, baseMessage.id);
          }
          getMessagesScroller() {
            return typeof document > "u" ? null : document.querySelector(BDFDB.dotCN.messagesscroller);
          }
          ...
          findMessageElementById(messageId) {
            if (!messageId || typeof document > "u") return null;
            let escapedId = typeof CSS < "u" && CSS.escape ? CSS.escape(String(messageId)) : String(messageId).replace(/(["\\])/g, "\\$1"), selectors = [
          ...
          findVisibleMessageAnchorElement(messagesScroller = null) {
            if (messagesScroller = messagesScroller || this.getMessagesScroller(), !messagesScroller || typeof document > "u") return null;
            ...
            for (let element of candidates) {
              ...
              seen.add(element);
              let messageId = this.extractMessageIdFromElement(element);
          ...
          captureMessageAnchorState(messageId = null) {
            let messagesScroller = this.getMessagesScroller(), element = messageId ? this.findMessageElementById(messageId) : null;
            if (!element) {
              let visibleAnchor = this.findVisibleMessageAnchorElement(messagesScroller);
          ...
          restoreMessageAnchorPosition(anchorState) {
            ...
            let messagesScroller = this.getMessagesScroller(), element = this.findMessageElementById(anchorState.messageId);
          ...
          lockManualTranslationScroll(messageId) {
            let anchorState = this.captureMessageAnchorState(messageId);
            anchorState && (manualTranslationScrollAnchor = anchorState, manualTranslationScrollLockTimer && clearTimeout(manualTranslationScrollLockTimer), manualTranslationScrollLockTimer = setTimeout((_2) => {
              manualTranslationScrollLockTimer = null, manualTranslationScrollAnchor = null;
            }, MANUAL_TRANSLATION_SCROLL_LOCK_MS));
          }
          getActiveManualTranslationScrollAnchor() {
            return manualTranslationScrollAnchor ? Date.now() > manualTranslationScrollAnchor.expiresAt ? (manualTranslationScrollAnchor = null, null) : manualTranslationScrollAnchor : null;
          }
          captureMessageScrollerState() {
            let messagesScroller = this.getMessagesScroller();
            if (!messagesScroller) return null;
            let maxScrollTop = Math.max(0, messagesScroller.scrollHeight - messagesScroller.clientHeight), keepBottom = Math.max(0, maxScrollTop - messagesScroller.scrollTop) <= AUTO_TRANSLATION_BOTTOM_LOCK_THRESHOLD;
            return {
              scrollTop: messagesScroller.scrollTop,
              keepBottom,
          ...
          getLoadedAutoTranslationStatusText(status) {
            let total = Math.max(0, status && status.total || 0), processed = Math.max(0, Math.min(total || 0, status && status.processed || 0)), displayed = Math.max(0, Math.min(total || 0, status && status.displayed || 0)), skipped = Math.max(0, Math.min(total || 0, status && status.skipped || 0)), failedValue = status && status.failed != null ? status.failed : status && status.aiDropped, failed = Math.max(0, failedValue || 0), retryable = Math.max(0, status && status.retryable || 0), batch = Math.max(1, status && status.batch || 1), extraText = `${skipped ? this.isChineseUiLanguage() ? `，跳过 ${skipped}` : `, skipped ${skipped}` : ""}${failed ? this.isChineseUiLanguage() ? `，失败 ${failed}` : `, failed ${failed}` : ""}${retryable && retryable != failed ? this.isChineseUiLanguage() ? `，待重试 ${retryable}` : `, retry pending ${retryable}` : ""}`;
            return status && status.done ? total ? this.isChineseUiLanguage() ? `已加载翻译：第 ${batch} 批完成，显示 ${displayed}/${total}${extraText}` : `Loaded translation: batch ${batch} done, shown ${displayed}/${total}${extraText}` : failed || retryable ? this.isChineseUiLanguage() ? `已加载翻译：失败 ${failed}，待重试 ${retryable}` : `Loaded translation: ${failed} failed, ${retryable} retry pending` : this.isChineseUiLanguage() ? "已加载翻译：开启，暂无待翻译" : "Loaded translation: on, no pending messages" : status && status.collecting ? this.isChineseUiLanguage() ? `收集已加载：第 ${batch} 批 ${processed}/${total}${extraText}` : `Collecting loaded: batch ${batch} ${processed}/${total}${extraText}` : total ? this.isChineseUiLanguage() ? `翻译已加载：第 ${batch} 批 ${processed}/${total}，显示 ${displayed}${extraText}` : `Translating loaded: batch ${batch} ${processed}/${total}, shown ${displayed}${extraText}` : this.isChineseUiLanguage() ? "已加载翻译：开启，等待消息" : "Loaded translation: on, waiting";
          }
          ...
          getLoadedAutoTranslationStatusTitleText(status) {
            if (!status) return "";
            let baseText = this.getLoadedAutoTranslationStatusText(status), detailParts = [];
          ...
          getLoadedAutoTranslationInlineStatusText(channelId = null) {
            let selectedChannelId = channelId || BDFDB.LibraryStores.SelectedChannelStore.getChannelId(), statusChannelId = loadedAutoTranslationStatus && loadedAutoTranslationStatus.channelId;
            return loadedAutoTranslationStatus && (loadedAutoTranslationStatus.active || loadedAutoTranslationStatus.done) && (!statusChannelId || statusChannelId == "__global" || statusChannelId == selectedChannelId) ? this.getLoadedAutoTranslationStatusText(loadedAutoTranslationStatus) : this.isChineseUiLanguage() ? "已加载消息自动翻译已开启，等待当前批次…" : "Loaded-message auto-translate is on; waiting for the current batch…";
          }
          ...
          positionLoadedAutoTranslationStatusElement(element) {
            ...
            for (let selector of selectors)
              if (selector)
                try {
                  anchors = anchors.concat(Array.from(document.querySelectorAll(selector)).filter(Boolean));
                } catch {
                }
            anchors = anchors.map((anchor2) => {
              ...
              let nearBottom = Math.max(0, window.innerHeight - rect.bottom), score = Math.min(rect.width, 900) - nearBottom * 2 + rect.right * 0.05;
              return { anchor: anchor2, rect, score };
            }).filter(Boolean).sort((a, b) => b.score - a.score);
            let anchorData = anchors[0], anchor = anchorData && anchorData.anchor, viewportPadding = 12, maxStatusWidth = Math.max(180, Math.min(360, window.innerWidth - viewportPadding * 2));
            ...
            if (element.style.right = "auto", element.style.bottom = "auto", anchor && anchor.getBoundingClientRect) {
              ...
              top = Math.max(viewportPadding, Math.min(top, window.innerHeight - statusHeight - viewportPadding)), element.style.left = `${Math.round(left)}px`, element.style.top = `${Math.round(top)}px`;
            } else
              element.style.left = `${Math.max(viewportPadding, window.innerWidth - statusWidth - 108)}px`, element.style.top = `${Math.max(viewportPadding, window.innerHeight - statusHeight - 54)}px`;
          }
          isChannelTextAreaFocused() {
            if (typeof document > "u") return !1;
            let activeElement = document.activeElement;
            return !activeElement || activeElement == document.body || !(activeElement.tagName == "TEXTAREA" || activeElement.tagName == "INPUT" || activeElement.getAttribute && activeElement.getAttribute("role") == "textbox" || activeElement.isContentEditable) ? !1 : [BDFDB.dotCN && BDFDB.dotCN.channeltextarea, '[class*="channelTextArea"]', "form"].some((selector) => {
          ...
          updateLoadedAutoTranslationStatus(updates = {}) {
            if (loadedAutoTranslationStatus = Object.assign({}, loadedAutoTranslationStatus, updates), !this.shouldShowLoadedAutoTranslationStatus(loadedAutoTranslationStatus)) {
              this.removeLoadedAutoTranslationStatusElement();
              return;
            }
            if (loadedAutoTranslationStatusHideTimer && (clearTimeout(loadedAutoTranslationStatusHideTimer), loadedAutoTranslationStatusHideTimer = null), typeof document > "u" || !document.body) return;
            ...
            let retryableCount = Math.max(0, loadedAutoTranslationStatus.retryable || 0), showRetry = !loadedAutoTranslationStatus.active && retryableCount > 0;
            element.className = `translator-loaded-status-floating${showRetry ? " translator-loaded-status-retryable" : ""}`, (!element.querySelector(".translator-loaded-status-text") || element.querySelector(".translator-loaded-status-progress")) && (element.innerHTML = '<span class="translator-loaded-status-dot"></span><span class="translator-loaded-status-text"></span>');
            let textElement = element.querySelector(".translator-loaded-status-text");
            textElement && (textElement.textContent = this.getLoadedAutoTranslationStatusText(loadedAutoTranslationStatus));
            ...
            showRetry ? (retryButton || (retryButton = document.createElement("button"), retryButton.type = "button", retryButton.className = "translator-loaded-status-retry", element.appendChild(retryButton)), retryButton.textContent = this.isChineseUiLanguage() ? "重试" : "Retry", retryButton.title = this.isChineseUiLanguage() ? `重试 ${retryableCount} 条失败消息` : `Retry ${retryableCount} failed messages`, retryButton.onclick = (event) => {
              ...
              let retryResult = this.retryFailedHistoricalTranslations(loadedAutoTranslationStatus.channelId);
              retryResult && typeof retryResult.catch == "function" && retryResult.catch((_2) => {
              });
            }) : retryButton && retryButton.remove(), element.title = this.getLoadedAutoTranslationStatusTitleText(loadedAutoTranslationStatus), this.updateInlineLoadedAutoTranslationStatusElements(), this.positionLoadedAutoTranslationStatusElement(element), requestAnimationFrame((_2) => this.positionLoadedAutoTranslationStatusElement(element));
          }
          hideLoadedAutoTranslationStatus(delay = 1600) {
            if (loadedAutoTranslationStatusHideTimer && clearTimeout(loadedAutoTranslationStatusHideTimer), this.shouldShowLoadedAutoTranslationStatus(loadedAutoTranslationStatus)) {
              loadedAutoTranslationStatusHideTimer = null, this.updateLoadedAutoTranslationStatus({});
              return;
            }
            loadedAutoTranslationStatusHideTimer = setTimeout((_2) => {
              loadedAutoTranslationStatusHideTimer = null, this.removeLoadedAutoTranslationStatusElement();
            }, delay);
          }
          clearLoadedAutoTranslationStatus() {
            loadedAutoTranslationStatusHideTimer && clearTimeout(loadedAutoTranslationStatusHideTimer), loadedAutoTranslationStatusHideTimer = null, loadedAutoTranslationStatus = { active: !1, collecting: !1, channelId: null, total: 0, processed: 0, batch: 0, displayed: 0, skipped: 0, failed: 0, retryable: 0, aiDropped: 0, lastSkipReason: "", lastSkipPreview: "" };
            let element = typeof document < "u" && document.getElementById("DiscordAITranslator-loaded-status");
          ...
          clearDisplayedTranslations(channelId = null) {
            for (let messageId of Object.keys(translatedMessages))
              channelId && this.getDisplayedTranslationChannelId(messageId) != channelId || this.clearDisplayedTranslationState(messageId);
            for (let messageId of Object.keys(replyPreviewTranslations))
              channelId && replyPreviewTranslations[messageId].channelId != channelId || (delete replyPreviewTranslations[messageId], delete queuedReplyPreviewTranslations[messageId]);
          }
          clearDisplayedAutoTranslations(channelId = null) {
            for (let messageId of Object.keys(translatedMessages)) {
              let translation = translatedMessages[messageId];
              !translation || !translation.auto || channelId && this.getDisplayedTranslationChannelId(messageId) != channelId || this.clearDisplayedTranslationState(messageId);
            }
            for (let messageId of Object.keys(replyPreviewTranslations)) {
              let translation = replyPreviewTranslations[messageId];
              !translation || !translation.auto || channelId && translation.channelId != channelId || (delete replyPreviewTranslations[messageId], delete queuedReplyPreviewTranslations[messageId]);
            }
          ...
          detachAutoTranslationInputActivityWatcher() {
            ...
            for (let eventName of ["beforeinput", "input", "keydown"]) document.removeEventListener(eventName, autoTranslationInputActivityHandler, !0);
            autoTranslationInputActivityHandler = null;
          }
          clearAutoTranslationScrollIntent() {
            autoTranslationScrollIntentTimer && clearTimeout(autoTranslationScrollIntentTimer), autoTranslationScrollIntentTimer = null, autoTranslationScrollIntentPending = !1;
          }
          markAutoTranslationScrollIntent() {
            this.clearAutoTranslationScrollIntent(), autoTranslationScrollIntentPending = !0, autoTranslationScrollIntentTimer = setTimeout(() => {
              autoTranslationScrollIntentTimer = null, autoTranslationScrollIntentPending = !1;
            }, AUTO_TRANSLATION_SCROLL_INTENT_WINDOW);
          }
          finishAutoTranslationScrollActivity(channelId) {
            autoTranslationScrollIdleTimer && clearTimeout(autoTranslationScrollIdleTimer), autoTranslationScrollIdleTimer = null, this.clearAutoTranslationScrollIntent(), (!channelId || autoTranslationUserScrollChannelId == channelId) && (lastAutoTranslationUserScrollTime = 0, autoTranslationUserScrollChannelId = null), channelId && this.finishHistoricalTranslationSnapshot(channelId);
          }
          scheduleAutoTranslationScrollIdleFinish(channelId, delay = AUTO_TRANSLATION_SCROLL_IDLE_DELAY) {
            channelId && (autoTranslationScrollIdleTimer && clearTimeout(autoTranslationScrollIdleTimer), autoTranslationScrollIdleTimer = setTimeout(() => {
              autoTranslationScrollIdleTimer = null, this.finishAutoTranslationScrollActivity(channelId);
            }, delay));
          }
          ...
          detachAutoTranslationScrollWatcher() {
            if (autoTranslationScrollIdleTimer && clearTimeout(autoTranslationScrollIdleTimer), autoTranslationScrollIdleTimer = null, this.clearAutoTranslationScrollIntent(), lastAutoTranslationUserScrollTime = 0, autoTranslationUserScrollChannelId = null, autoTranslationScrollWatcherElement) {
              if (autoTranslationScrollActivityHandler && autoTranslationScrollWatcherElement.removeEventListener("scroll", autoTranslationScrollActivityHandler), autoTranslationScrollEndHandler && autoTranslationScrollWatcherElement.removeEventListener("scrollend", autoTranslationScrollEndHandler), autoTranslationScrollIntentHandler) for (let eventName of ["wheel", "touchmove", "pointerdown", "keydown"]) autoTranslationScrollWatcherElement.removeEventListener(eventName, autoTranslationScrollIntentHandler);
              if (autoTranslationScrollIntentEndHandler) for (let eventName of ["pointerup", "pointercancel"]) autoTranslationScrollWatcherElement.removeEventListener(eventName, autoTranslationScrollIntentEndHandler);
            }
            autoTranslationScrollWatcherAttached = !1, autoTranslationScrollWatcherElement = null, autoTranslationScrollActivityHandler = null, autoTranslationScrollIntentHandler = null, autoTranslationScrollIntentEndHandler = null, autoTranslationScrollEndHandler = null;
          }
          isViewingMessageHistory() {
            let scrollerState = this.captureMessageScrollerState();
            return !!(scrollerState && !scrollerState.keepBottom);
          }
          isUserActivelyScrollingMessages(channelId = null) {
            return channelId = channelId || BDFDB.LibraryStores.SelectedChannelStore.getChannelId(), !!channelId && autoTranslationUserScrollChannelId == channelId && !!lastAutoTranslationUserScrollTime && Date.now() - lastAutoTranslationUserScrollTime < AUTO_TRANSLATION_SCROLL_IDLE_DELAY;
          }
...
需要翻译时只输出译文；不需要翻译时只输出 __SKIP_TRANSLATION__。`
          ...
          createStoredReceivedTranslationData(message, channelId, originalContentData, signature, translation, input, output, auto = !1) {
            if (!translation) return null;
            let strings = String(translation).split(/\n{0,1}__________________ __________________ __________________\n{0,1}/), oldContent = (originalContentData && originalContentData.content || "").trim(), translatedContent = (strings.shift() || "").trim();
            if (!translatedContent) return null;
            let content = this.buildReceivedDisplayContent(translatedContent, oldContent), embedIds = (message && message.embeds || []).map((embed) => embed && embed.id).filter(Boolean), embeds = strings.reduce((dict, segment, index) => {
              let embedId = embedIds[index];
              if (!embedId) return dict;
              let segmentLines = segment.split(`
`), title = segmentLines.shift(), description = segmentLines.shift(), footerText = segmentLines.pop(), fields = segmentLines.join(`
`).split(`
...
`).map((line) => {
              ...
              return dict[embedId] = { title, description, fields, footerText }, dict;
            }, {});
            return {
              signature,
              channelId,
          ...
          createHistoricalTranslationRetrySnapshot(item, channelId) {
            ...
            let message = new BDFDB.DiscordObjects.Message(item.message);
            return message.embeds = (item.message.embeds || []).map((embed) => Object.assign({}, embed, {
          ...
          retryFailedHistoricalTranslations(channelId = null) {
            ...
            this.updateLoadedAutoTranslationStatus({
              ...
              channelId,
              batch: (loadedAutoTranslationStatus.channelId == channelId && loadedAutoTranslationStatus.batch || 0) + 1,
          ...
          startCollectedHistoricalTranslationJobs(channelId, options = {}) {
            ...
            let runningPromise = Promise.resolve(job.start()).finally((_2) => {
              for (let record of job.items.values()) {
                let messageId = record && record.source && record.source.message && record.source.message.id, queuedMarker = messageId && queuedAutoTranslations[messageId];
                queuedMarker && queuedMarker.type == "historical" && queuedMarker.jobId == job.id && delete queuedAutoTranslations[messageId];
              }
          ...
          invalidateHistoricalTranslationMessage(messageId, channelId, currentSignature) {
            ...
            if (invalidated && (delete queuedAutoTranslations[messageId], this.clearCachedTranslation(messageId), loadedAutoTranslationStatus.channelId == channelId && loadedAutoTranslationStatus.done)) {
              let failedCount = this.getFailedHistoricalTranslationCount(channelId), visibleFailedCount = Math.min(loadedAutoTranslationStatus.failed || 0, failedCount);
          ...
          cancelHistoricalTranslationJobs(channelId = null, reason = "cancelled") {
            ...
            for (let entry of entries) {
              ...
              for (let job of entry.jobs) {
                job.cancel(reason);
                for (let record of job.items.values()) record.source && record.source.message && delete queuedAutoTranslations[record.source.message.id];
              }
...
`).trim();
          ...
          commitHistoricalTranslationJob(summary, job) {
            ...
            for (let item of summary.translated)
              !item || !item.message || !item.translation || (this.applyStoredTranslationToMessage(item.message, item.translation, item.originalContentData), this.persistTranslationCacheEntry(item.message.id, item.translation.signature, item.translation), delete queuedAutoTranslations[item.message.id]);
            for (let item of summary.skipped) {
              ...
              this.persistReceivedSkipDecision(item.message.id, signature, item.reason || "local_guard", this.buildTranslationRequestText(item.originalContentData || {})), delete queuedAutoTranslations[item.message.id];
            }
            for (let item of summary.failed) item && item.message && delete queuedAutoTranslations[item.message.id];
            let failedCount = this.updateFailedHistoricalTranslationSnapshots(summary, job.channelId);
            this.updateLoadedAutoTranslationStatus({ active: !1, collecting: !1, done: !0, channelId: job.channelId, total: job.items.size, processed: job.items.size, displayed: summary.translated.length, skipped: summary.skipped.length, failed: summary.failed.length, retryable: failedCount, aiDropped: summary.failed.length });
          }
...
${JSON.stringify(payloadItems)}`, finish = /* @__PURE__ */ __name((content) => resolve(this.parseAiBatchTranslationResponse(content, payloadItems.map((item) => item.id))), "finish");
          ...
          processMessageButtons(e) {
            ...
            if (index == -1) return;
            let channelId = e.instance.props.channel && e.instance.props.channel.id || null, translated = !!this.getActiveMessageTranslation(e.instance.props.message, channelId);
          ...
          getActiveChannelTitleTranslation(channel) {
            ...
            let entry = translatedChannelTitles[channel.id], signature = this.getChannelTitleTranslationSignature(channel);
            return !entry || entry.signature != signature ? (entry && delete translatedChannelTitles[channel.id], null) : entry.text;
          }
          cancelPendingChannelTitleTranslation(channelId = null) {
            if (!channelId) {
              pendingChannelTitleTranslations = {}, failedChannelTitleTranslations = {};
              return;
            }
            delete pendingChannelTitleTranslations[channelId], delete failedChannelTitleTranslations[channelId];
          }
          clearChannelTitleTranslations(channelId = null) {
            let hadTranslatedTitle = channelId ? !!translatedChannelTitles[channelId] : !!Object.keys(translatedChannelTitles).length;
            this.cancelPendingChannelTitleTranslation(channelId), channelId ? delete translatedChannelTitles[channelId] : translatedChannelTitles = {}, hadTranslatedTitle && this.forceUpdateChannelTitleComponents();
          }
          queueChannelTitleTranslation(channel) {
            ...
            if (!signature || translatedChannelTitles[channelId] && translatedChannelTitles[channelId].signature == signature || pendingChannelTitleTranslations[channelId] && pendingChannelTitleTranslations[channelId].signature == signature || failedChannelTitleTranslations[channelId] && failedChannelTitleTranslations[channelId].signature == signature && failedChannelTitleTranslations[channelId].retryAfter > Date.now()) return !1;
            let request = { id: ++channelTitleTranslationSequence, channelId, signature };
            return pendingChannelTitleTranslations[channelId] = request, this.translateText(channel.name, messageTypes.RECEIVED, (translation, _input, _output, meta = {}) => {
              if (pendingChannelTitleTranslations[channelId] === request && (delete pendingChannelTitleTranslations[channelId], !(!pluginRuntimeActive || !this.isTranslationEnabled(channelId) || this.getChannelTitleTranslationSignature(channel) != signature))) {
                if (!translation && !(meta && meta.skipped)) {
                  failedChannelTitleTranslations[channelId] = { signature, retryAfter: Date.now() + 3e4 };
                  return;
                }
                translatedChannelTitles[channelId] = { signature, text: translation || channel.name }, delete failedChannelTitleTranslations[channelId], this.forceUpdateChannelTitleComponents();
              }
            }, null, { auto: !0, showToast: !1, showFailureToast: !1, trackBusy: !1, channelId }), !0;
          }
          ...
          isEngineConfiguredForRuntime(engineKey) {
            ...
            if (!["microsoft", "googlecloud", "deepl", "deepseek", "openai", "gemini", "oaicompat"].includes(engineKey)) return !0;
            let auth = authKeys[engineKey] || {};
...
> `)}` : "";
          ...
          translateMessage(message, channel, options = {}) {
            return new Promise((callback) => {
              ...
              let activeTranslation = this.getActiveMessageTranslation(message, channelId);
              if (isManualTranslation && !activeTranslation && manualMessageTranslationRequests[manualRequestKey]) return finish(!1);
              if (isManualTranslation && this.lockManualTranslationScroll(message.id), activeTranslation) {
                if (options.auto) return finish(!1);
                suppressedAutoTranslations[message.id] = !0, this.clearDisplayedTranslationState(message.id, {
                  clearReplyPreview: !0,
                  preserveSuppressed: !0
                }), this.scheduleTranslationRerender(), finish(!1);
              } else {
                ...
                if (this.shouldSkipReceivedTranslationBeforeRequest(originalContentData, channelId)) {
                  let skipReason = this.getReceivedAutoTranslateSkipReason(originalContentData, channelId) || "same_language";
                  return this.persistReceivedSkipDecision(message.id, this.createReceivedTranslationSignature(message, channelId, originalContentData), skipReason, this.buildTranslationRequestText(originalContentData)), finish(!1);
                }
                ...
                isManualTranslation && (manualRequest = {}, manualMessageTranslationRequests[manualRequestKey] = manualRequest);
                try {
                  this.translateText(allTextsToTranslate, messageTypes.RECEIVED, (translation, input, output, meta = {}) => {
                    try {
                      if (options.auto && !this.isLiveTranslationRequestCurrent(liveRequest, message) || isManualTranslation && manualMessageTranslationRequests[manualRequestKey] !== manualRequest) return finish(!1);
                      if (translation) {
                        let strings = translation.split(/\n{0,1}__________________ __________________ __________________\n{0,1}/), oldContent = (originalContentData.content || "").trim(), translatedContent = (strings.shift() || "").trim(), content = this.buildReceivedDisplayContent(translatedContent, oldContent), embeds = strings.reduce((dict, segment, index) => {
                          let embedId = embedIds[index], segmentLines = segment.split(`
`), title = segmentLines.shift(), description = segmentLines.shift(), footerText = segmentLines.pop(), fields = segmentLines.join(`
`).split(`
...
`).map((line) => {
                        ...
                        if (options.auto && rejectReason || this.isTranslationResultTooSimilar(storedTranslation))
                          return this.persistReceivedSkipDecision(message.id, signature, rejectReason || "too_similar", storedTranslation.originalContent || storedTranslation.translatedContent), finish(!1);
                      ...
                      } else meta && meta.skipped && options.auto && this.persistReceivedSkipDecision(message.id, signature, "ai_skip_signal", allTextsToTranslate);
          ...
          getModelCatalogEndpoint(engineKey, endpoint) {
            let normalized = this.normalizeApiEndpoint(engineKey, endpoint);
          ...
          fetchModelCatalog(engineKey, onUpdate = null) {
            return new Promise((resolve) => {
              ...
              if (engineKey == "oaicompat" && (!(auth.endpoint || "").trim() || (auth.endpoint || "").trim() == translationEngines.oaicompat.endpoint))
                return BDFDB.NotificationUtils.toast(`${engineLabel}: ${this.getCustomText("validate_missing_endpoint")}`, { type: "danger", position: "center" }), resolve({ ok: !1, items: [] });
              let normalizedEndpoint = this.normalizeApiEndpoint(engineKey, auth.endpoint || translationEngines[engineKey] && translationEngines[engineKey].endpoint || "");
              if (!normalizedEndpoint)
                return BDFDB.NotificationUtils.toast(`${engineLabel}: ${this.getCustomText("validate_missing_endpoint")}`, { type: "danger", position: "center" }), resolve({ ok: !1, items: [] });
              auth.endpoint && normalizedEndpoint != auth.endpoint && (auth.endpoint = normalizedEndpoint, authKeys[engineKey] = auth, BDFDB.DataUtils.save(authKeys, this, "authKeys"), this.SettingsUpdated = !0);
              let modelCatalogEndpoint = this.getModelCatalogEndpoint(engineKey, normalizedEndpoint), requestUrl = engineKey == "gemini" ? `${modelCatalogEndpoint}?key=${encodeURIComponent(apiKey)}` : modelCatalogEndpoint;
              updateState({ loading: !0, items: [], endpoint: requestUrl });
              let requestHeaders = { "Content-Type": "application/json" };
              engineKey != "gemini" && (requestHeaders.Authorization = `Bearer ${apiKey}`), BDFDB.LibraryRequires.request(requestUrl, {
                method: "get",
                ...
                if (!error && body && response && response.statusCode == 200)
                  try {
                    ...
                    return updateState({
                      ...
                      items.length ? `${engineLabel}: ${this.getCustomText("model_catalog_loaded").replace("{count}", items.length)}` : `${engineLabel}: ${this.getCustomText("model_catalog_empty")}`,
                      {
                ...
                return BDFDB.NotificationUtils.toast(
          ...
          validateEngineConfig(engineKey) {
            return new Promise((resolve) => {
              ...
              if (translationEngines[engineKey] && translationEngines[engineKey].endpoint && (apiEndpoint = this.normalizeApiEndpoint(engineKey, auth.endpoint || translationEngines[engineKey].endpoint), auth.endpoint && apiEndpoint != auth.endpoint && (auth.endpoint = apiEndpoint, authKeys[engineKey] = auth, BDFDB.DataUtils.save(authKeys, this, "authKeys"), this.SettingsUpdated = !0, normalized = !0), !apiEndpoint))
                return finish(!1, `${engineLabel}: ${this.getCustomText("validate_missing_endpoint")}`, normalized);
              let modelId = (auth.model || translationEngines[engineKey] && translationEngines[engineKey].model || "").trim();
              if (["deepseek", "openai", "gemini", "oaicompat"].includes(engineKey) && !modelId) return finish(!1, `${engineLabel}: ${this.getCustomText("validate_missing_model")}`, normalized);
              let sample = this.getValidationRequestForEngine(engineKey);
              ...
              switch (engineKey) {
                case "googlecloud": {
                  ...
                  return model && (form.model = model), BDFDB.LibraryRequires.request(apiEndpoint, {
                    method: "post",
                    form
                  }, (error, response, body) => {
                    if (!error && body && response && response.statusCode == 200)
                ...
                case "microsoft": {
                  ...
                  return region && region != "global" && (headers["Ocp-Apim-Subscription-Region"] = region), BDFDB.LibraryRequires.request(apiEndpoint, {
                    method: "post",
                    headers,
...
${sample.text}`,
                    ...
                    let translation = !error && response && response.statusCode == 200 ? this.parseOpenAiResponseText(body) : "";
...
${sample.text}` }] }]
                    ...
                    let translation = !error && response && response.statusCode == 200 ? this.parseGeminiResponseText(body) : "";
                    return finish(!!translation, translation ? successMessage(translation) : failMessage(response && response.statusCode, body), normalized);
                  });
                }
                case "deepseek":
...
${sample.text}`
              ...
              return finish(!1, `${engineLabel}: ${this.getCustomText("validate_failed")}`, normalized);
            });
          }
          googleApiTranslate(data, callback) {
            BDFDB.LibraryRequires.request("https://translate.googleapis.com/translate_a/single", {
              ...
              if (!error && body && response.statusCode == 200)
                ...
                response.statusCode == 429 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_hourlylimit}`, {
                  type: "danger",
                  position: "center"
          ...
          googleCloudTranslate(data, callback) {
            let apiKey = authKeys.googlecloud && authKeys.googlecloud.key || "", apiEndpoint = authKeys.googlecloud && authKeys.googlecloud.endpoint || translationEngines.googlecloud.endpoint, modelId = authKeys.googlecloud && authKeys.googlecloud.model || translationEngines.googlecloud.model;
            BDFDB.LibraryRequires.request(apiEndpoint, {
              ...
              if (!error && body && response.statusCode == 200)
                ...
                response && (response.statusCode == 401 || response.statusCode == 403) ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_keyoutdated}`, {
                  type: "danger",
                  position: "center"
                }) : response && response.statusCode == 429 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_hourlylimit}`, {
                  type: "danger",
                  position: "center"
                }) : BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_serverdown}`, {
                  type: "danger",
          ...
          microsoftTranslate(data, callback) {
            let apiEndpoint = this.normalizeApiEndpoint("microsoft", authKeys.microsoft && authKeys.microsoft.endpoint || translationEngines.microsoft.endpoint), apiKey = authKeys.microsoft && authKeys.microsoft.key || "", region = authKeys.microsoft && authKeys.microsoft.region || "", headers = {
              "Content-Type": "application/json",
              "Ocp-Apim-Subscription-Key": apiKey
            };
            region && region != "global" && (headers["Ocp-Apim-Subscription-Region"] = region), BDFDB.LibraryRequires.request(apiEndpoint, {
              method: "post",
              headers,
              ...
              if (!error && body && response.statusCode == 200)
                ...
                response.statusCode == 403 || response.statusCode == 429 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_dailylimit}`, {
                  type: "danger",
                  position: "center"
                }) : response.statusCode == 401 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_keyoutdated}`, {
                  type: "danger",
                  position: "center"
                }) : BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_serverdown}`, {
                  type: "danger",
          ...
          deepLTranslate(data, callback) {
            BDFDB.LibraryRequires.request(authKeys.deepl && authKeys.deepl.paid ? "https://api.deepl.com/v2/translate" : "https://api-free.deepl.com/v2/translate", {
              ...
              if (!error && body && response.statusCode == 200)
                ...
                response.statusCode == 429 || response.statusCode == 456 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_dailylimit}`, {
                  type: "danger",
                  position: "center"
                }) : response.statusCode == 403 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_keyoutdated}`, {
                  type: "danger",
                  position: "center"
                }) : BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_serverdown}`, {
                  type: "danger",
          ...
          requestAiProviderTranslation(engineKey, url, options, parseResponse, callback) {
            this.requestWithTimeout(url, options, (error, response, body) => {
              ...
              let engineName = translationEngines[engineKey] && translationEngines[engineKey].name || engineKey, details = this.getValidationErrorDetails(body);
          ...
          openAiTranslate(data, callback) {
            let auth = authKeys.openai || {}, apiKey = auth.key || "", apiEndpoint = this.normalizeApiEndpoint("openai", auth.endpoint || translationEngines.openai.endpoint), modelId = auth.model || translationEngines.openai.model, prompt = this.buildAiProviderTranslationPrompt(data);
          ...
          geminiTranslate(data, callback) {
            let auth = authKeys.gemini || {}, apiKey = auth.key || "", apiEndpoint = this.normalizeApiEndpoint("gemini", auth.endpoint || translationEngines.gemini.endpoint), modelId = (auth.model || translationEngines.gemini.model).replace(/^models\//, ""), prompt = this.buildAiProviderTranslationPrompt(data), requestUrl = `${apiEndpoint}/${encodeURIComponent(modelId)}:generateContent?key=${encodeURIComponent(apiKey)}`;
          ...
          chatCompletionsTranslate(engineKey, data, callback) {
            ...
            let auth = authKeys[engineKey] || {}, apiKey = auth.key || "", apiEndpoint = this.normalizeApiEndpoint(engineKey, auth.endpoint || translationEngines[engineKey].endpoint), modelId = auth.model || translationEngines[engineKey].model, prompt = this.buildAiProviderTranslationPrompt(data);
...
`), callback);
          ...
          iTranslateTranslate(data, callback) {
            let translate = /* @__PURE__ */ __name((_2) => {
              BDFDB.LibraryRequires.request("https://web-api.itranslateapp.com/v3/texts/translate", {
                ...
                if (!error && response && response.statusCode == 200)
                  ...
                  response.statusCode == 429 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_dailylimit}`, {
                    type: "danger",
                    position: "center"
                  }) : response.statusCode == 403 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_keyoutdated}`, {
                    type: "danger",
            ...
            authKeys.itranslate && authKeys.itranslate.key || data.engine.APIkey ? translate() : BDFDB.LibraryRequires.request("https://www.itranslate.com/js/webapp/main.js", { gzip: !0 }, (error, response, body) => {
              if (!error && body) {
                ...
                APIkey ? (data.engine.APIkey = APIkey[1], translate()) : callback("");
              } else callback("");
            });
          }
            ...
            BDFDB.LibraryRequires.request("https://translate.yandex.net/api/v1.5/tr/translate", {
              ...
              if (!error && body && response.statusCode == 200)
                try {
                  ...
                  let translation = body.querySelector("text"), detected = body.querySelector("detected");
              ...
              else body && body.indexOf('code="408"') > -1 ? (BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_monthlylimit}`, {
                type: "danger",
                position: "center"
              }), callback("")) : (BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_serverdown}/${this.labels.error_keyoutdated}`, {
                type: "danger",
                position: "center"
              }), callback(""));
            });
          ...
          baiduTranslate(data, callback) {
            let credentials = (authKeys.baidu && authKeys.baidu.key || "").split(" "), salt = BDFDB.NumberUtils.generateId();
              ...
              if (!error && result && response.statusCode == 200)
                try {
                  if (result = JSON.parse(result) || {}, result.error_code)
                    result.error_code == 54004 ? BDFDB.NotificationUtils.toast(`${this.labels.toast_translating_failed}. ${this.labels.toast_translating_tryanother}. ${this.labels.error_monthlylimit}.`, {
                      type: "danger",
                      position: "center"
