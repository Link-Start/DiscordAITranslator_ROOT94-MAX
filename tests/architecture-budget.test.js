...
// Track legacy growth explicitly. Prefer lowering these budgets, and document
// any functional wiring increase below. Do not satisfy a line budget by compressing
// working code or introducing wrapper modules with no independent responsibility.
const BUDGET = Object.freeze({
	...
	// -2 (2026-08-22): retired iTranslate/Yandex forwarding methods funded persisted
	// engine-selection migration without growing the composition root.
	// -1 (2026-08-22): engine labels collapsed to the short draft vocabulary and
	// language display names became single-script per interface language; the
	// custom-engine sync call rides inside setLanguages().
	// -55 (2026-08-23): removed orphan fixed quote-protection helpers and hidden
	// received-policy accessors now represented by explicit internal constants.
	// -2 (2026-08-26): F1H1 moved primary/repair dispatch policy behind the historical performance wiring.
	// -3 (2026-08-27): S8a validation classification moved to its own observer module.
	// -3 (2026-08-28): M3h unified historical primary selection and retired duplicated batch-only gate lines.
	// -18 (2026-08-29): historical semantic/legacy queue-item preparation moved
	// behind its orchestrator wiring boundary while P1 added protection replay.
	// -7 (2026-09-06): existing history validation moves behind its classifier; W5 delegates there.
	// -37 (2026-09-06): history progress/final commit shares the existing cache finalizer.
	// -4 (2026-09-15): source signature ownership moved to the cache wiring module.
	// +6 (2026-09-16): actual-client fix adds the revision comparator installation
	// and handles unconfirmed channel-disable restores at their existing caller.
	// Keep this wiring readable; do not compress it or extract a trivial wrapper
	// merely to satisfy the historical line-count target.
	runtimeLines: 3078,
