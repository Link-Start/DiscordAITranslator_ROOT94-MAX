...
function createPluginMessageDeletionLifecycle({
	...
	return createLifecycle({
		...
		removeManualMessage: (messageId, channelId) => {const store = plugin.ensureSentTranslationStore(); return store.cancelManualRequest(store.createManualRequestKey(channelId, messageId));},
