function createMessageDeletionLifecycle({
	...
	async function deleteMessage(messageId, channelId) {
		...
		const manualRemoved = removeManualMessage(messageId, channelId);
		...
		return {messageId, channelId, removed: !!(manualRemoved || liveRemoved || historicalRemoved || cacheRemoved || displayOutcome), displayOutcome};
	}
